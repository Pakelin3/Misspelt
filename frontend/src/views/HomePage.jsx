    ...
    return (
        <div className='min-h-auto my-20 '>
            <section className='flex justify-center min-h-96 items-center max-h-2/4 bg-gray-200 p-4'>
                {/* // TODO: Proximamente preview demo del juego */}
            ...
            <section className='flex justify-around m-20 gap-20 flex-wrap-reverse items-end'>
                ...
                <div className='className="block max-w-md p-6 bg-white border border-[var(--color-teal-400)] rounded-lg shadow-sm justify-self-start'>
                    <RandomWordCard />
                </div>


                <div
                    className="block max-w-md p-6 bg-white border border-[var(--color-teal-400)] rounded-lg shadow-sm"
                >
                    <Accordion />
                </div>
