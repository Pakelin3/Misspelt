                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[var(--color-teal-400)]">
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            >
                                <svg
                                    className="w-5 h-5 text-gray-500 transition duration-75 dark:text-[var(--color-pink-500)] group-hover:text-gray-900 dark:group-hover:text-white"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 22 21"
                    ...
                    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-[var(--color-pink-500)]">
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3">Dictionary</span>
                            </a>
                        </li>
                    </ul>
                </div>
