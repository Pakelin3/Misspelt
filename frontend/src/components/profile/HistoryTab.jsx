...
const HistoryTab = ({
    ...
    if (historyError) {
        return (
            <div role="alert" className="text-center p-12 bg-card pixel-border text-destructive animate-in fade-in duration-300">
                <p className="font-mono text-sm font-bold">{historyError}</p>
                <button
                    type="button"
                    onClick={() => onFetchHistory(historyPage)}
